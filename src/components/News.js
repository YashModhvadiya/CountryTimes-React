...
const News = (props) => {
    ...
    useEffect(() => {
    document.title=`${capitalizeFirstLetter(props.category)} -Country Times`
    ...
    return (
        ...
        <div className="continer" >
            <h1 className='text-center' style={{ margin: '35px 0px', color: 'black', marginTop:'90px' }}>Country Times - Top {capitalizeFirstLetter(props.category)} Headlines</h1>
            {loading && <Spinner />}
